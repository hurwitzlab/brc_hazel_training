...
- Error checking
Additionally, note that the the software **fastqc** is executed from an Apptainer container, not a module, so we also had to include paths to the container image, apart from input, output, etc.  
