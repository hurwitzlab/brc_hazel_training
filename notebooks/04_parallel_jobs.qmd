...
We skip the `#BSUB` directives entirely in your `.lsf` file and pass all resource requests directly to the bsub command in your launcher script. This is useful for pipelines where one launcher controls many different job scripts.
...
::: {.callout-tip}
## Best Practice
Use Approach 2 (variables from config) for most pipelines. It provides the best balance of flexibility and maintainability. In fact this is what we have used in the example code found here.
:::
